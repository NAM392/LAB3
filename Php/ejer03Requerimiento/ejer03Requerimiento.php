...
echo "<h2>En este ejemplo de utiliza la funcion require() que ubica codigo php definido en el archivo ejemplo2.inc : ";
...
echo "<h4>Aqui ya se ejecuto la funcion require() . Cuando se usa iclude ocurre que si el archivo 'inc' no existe , se visualiza un warning y el script sigue ejecutandose hasta el final </h4>";
